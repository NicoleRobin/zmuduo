...
TcpServer::~TcpServer()
{
	...
	LOG_TRACE << "TcpServer::~TcpServer [" << name_ << "] destruction";

	for (ConnectionMap::iterator it(connection_.begin());
...
void TcpServer::newConnection(int sockfd, const InetAddress &peerAddr)
{
	...
	conn->setConnectionCallback(messageCallback_);
...
void TcpServer::removeConnectionInLoop(const TcpConnectionPtr &conn)
{
	...
	ioLoop->queueInLoop(boost::bind(&TcpServer::connectDestroyed, conn));
}
